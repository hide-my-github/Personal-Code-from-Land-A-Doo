...
public class ScooterSpawner : MonoBehaviour {
	...
	public GameObject scooterGO;

	public float maxSpawnRateInSeconds;
	public float top;
	public float bottom;
	public float scooterSpeed = 0.0f;
	...
	void SpawnEnemy() {
		...
		anEnemy = (GameObject)Instantiate (scooterGO);

		anEnemy.GetComponent<ScooterControl>().setConstantSpeed(scooterSpeed);
